...
public class Dealer extends GameHelper {

    private int bank;
    private int allInBank;
    ...
    private List list = Arrays.asList(Deck);
    private ArrayList<String> cardDeck = new ArrayList<String>(list);

    public String setCard() {
        getRandomUnit(cardDeck);
        return super.currentRandomUnit;
    }
